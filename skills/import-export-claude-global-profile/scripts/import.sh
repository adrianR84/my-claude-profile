...
# Usage: sh scripts/import.sh [merge|clean]
...
for folder in $FOLDERS; do
    ...
    # Merge mode: do nothing if source does not exist (preserve destination)
done
...
# ---------------------------------------------------------------------------
# 4. Sanitize plugin JSON files (convert relative to absolute paths)
# ---------------------------------------------------------------------------
